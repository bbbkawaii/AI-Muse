      ...
      <section className="pt-28 pb-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-6xl mx-auto">
            ...
            {/* Music Player */}
            <div className="mt-10">
              <div className="glass-holographic rounded-2xl border border-glass-border overflow-hidden max-w-2xl mx-auto">
                {/* Cover Image */}
                ...
                {/* Player Controls */}
                <MusicDetailClient track={track} />
              </div>
            </div>

            {/* 作者信息和互动 */}
            <div className="mt-4 max-w-2xl mx-auto">
              <MusicDetailStats id={id} />
            </div>
...
// 需要单独的客户端组件来处理作者和点赞
import MusicDetailStats from "./MusicDetailStats";
